...
export async function GET(request) {
  ...
  // 👇 בניית השאילתה בדיוק כמו במנוע החלפים (העתק-הדבק של הלוגיקה שעובדת) 👇
  ...
  // חיפוש "חכם": 
  // 1. Title/Type עטופים במרכאות (JSON.stringify) לטיפול בטוח בטקסט
  // 2. SKU/Tags עוברים Escape לטיפול במקפים ותווים מיוחדים
