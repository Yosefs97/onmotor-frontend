...
export default function CommentsSection({ threadSlug, threadLocked }) {
  ...
  async function loadComments() {
    try {
      ...
      // 🧩 מיון היררכי – תגובה למישהו תמיד תופיע אחרי המגיב
      ...
      const sorted = sortHierarchical(data);
  ...
  return (
    <div>
      ...
      {/* 🟥 טופס תגובה לדיון עצמו */}
      {!threadLocked && (
        <form
          onSubmit={(e) => handleSubmit(e, null)}
          className="mb-8 border-2 border-[#e60000] rounded-xl bg-[#fffafa] shadow-sm p-6 text-black"
        >
