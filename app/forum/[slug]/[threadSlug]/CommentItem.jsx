      ...
      {replyTo === comment.id && (
        ...
        >
          <input
            ...
            className="w-full border border-[#e60000]/10 text-black rounded px-2 py-1 text-sm"
          />
          <textarea
            placeholder="תגובה..."
            value={replyText}
            onChange={(e) => setReplyText(e.target.value)}
            className="w-full border border-[#e60000]/20 rounded px-2 py-1 text-black text-sm h-20 resize-none"
          />
          <button
            type="submit"
