...
export async function fetchThreadsByCategorySlug(slug) {
  ...
  return (
    json.data?.map((item) => {
      ...
      // ✅ קובע מספר תגובות *מהקשר עצמו* כפי שחוזר מה-API
      const commentsCount =
