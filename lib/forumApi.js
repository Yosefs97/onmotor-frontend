...
export async function addCommentByThreadSlug({
  ...
  // ✅ הגוף בפורמט שמתחייב לפי Strapi v5
  const body = {
    data: {
      text,
      author,
      forum_thread: { connect: [threadId] }, // ✅ חיבור תקין לפי id
      reply_to: reply_to ? { connect: [reply_to] } : null,
  ...
  console.log("📩 תגובת Strapi (תגובה):", textRes);
