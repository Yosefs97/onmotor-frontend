        ...
        {testimonials.map((testimonial) => (
          ...
          >
            ...
            {testimonial.text && (
              ...
              <div className="p-3 text-center text-m font-bold text-green-700 dark:text-green-400 border-t border-gray-100 dark:border-gray-700 bg-gray-50/50 dark:bg-gray-800/50">
                {testimonial.text}
              </div>
            )}
          </div>
