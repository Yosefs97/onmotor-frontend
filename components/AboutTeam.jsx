...
const teamMembers = [
  {
    ...
    bio: 'רוכב על דו גלגלי על שלל סוגיו ובעצימות גבוהה כבר 14 שנים, במקצועו מנהל מוסך אופנועים. תפקידו באתר - רוכב בוחן , כותב ועורך כתבות במגזין.',
  ...
  },
  {
    ...
    age: 29,
    role: 'עורך ראשי',
    bio: 'רוכב על דו-גלגלי בשלל סוגיו וצורותיו מזה 16 שנים (ללא רגע אחד של "חסד"). במקצועו מהנדס מכונות. הקים את המגזין מתוך אהבה לדו גלגלי, רצון להנגיש מידע , טיפים ושאר תכנים מעולם הדו גלגלי לרוכב הישראלי.',
