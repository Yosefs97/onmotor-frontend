/* * * * * * * * * * * * * * * * * * * *
*
* NagishLi Docs - Installation Code Generator
* Copyright (c) 2019 Localize* (http://www.nagish.li)
*
* * * * * * * * * * * * * * * * * * * */
var msgs={info:"This is how extra information about the setting will be shown.",url:"For example, if your website address is http://www.mywebsite.com and you've placed NagishLi in a folder named 'plugins', to make things simple and avoid problems it is recommended to use the full address of NagishLi's location. In this example, the location will be:\n\nhttp://www.mywebsite.com/plugins\n\n* Notice: Do not include slash (/) at the end of the location - it will be added automatically to the generated code.",
ver:"This setting is not required, but useful.\n\nThere will be some situations when you'll upgrade NagishLi's version on your website but some of your visitors will still see the older version because web browsers cache files automatically to save resources and loading times.\n\nTo avoid these situations, it is recommended to change your installation code according to the version you are using.",statement:"If you have an accessibility statement page on your website, this setting allows you to link to it directly from NagishLi. For example:\n\nhttp://www.mywebsite.com/accessibilty.html\n\n* If you don't have an accessibility statement - worry not! NagishLi comes with a built-in statement. :)",
compact:"Compact mode allows you to choose how NagishLi will be shown when minimized.\n\nYes - NagishLi will be shown as an icon only.\nNo - NagishLi will be shown as a bar (an icon with the word 'Accessibility' and the positioning arrows next to it).",accordion:"Accordion mode allows you to choose how the opening state of NagishLi's menu will function.\n\nYes - Your users will be able to open one menu at a time.\nNo - Your users will be able to open multiple menus at a time.\n\n* Notice: As of NagishLi version 2.2.2, accordion mode is automatically active on mobile devices.",
dir:"This setting is relevant ONLY if you're moving or changing the name of the 'nl-files' directory.\n\nnl-files contains files that are essential for NagishLi to function properly. By default, NagishLi will look for this directory at the same place where 'nagishli.js' is found. If you wish to move NagishLi's files elsewhere and/or change the folder's name, you can set the url accordingly. For example:\n\nhttp://www.mywebsite.com/accessibility-folder/\n\n* Notice: The url MUST end with a slash (/).",
